...
\def\myfititle{Todellisen syvyyskartan generointi}
\def\myentitle{Estimating real depth data}
\def\myauthor{Esko Takku}
\def\myfisubtitle{Stereosyvyysdatan sekä segmentointi datasetin yhdistäminen, puhtaan syvyyskartan generointiin.}
