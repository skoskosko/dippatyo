...
\def\myentitle{Estimating hidden depth data}
\def\myauthor{Esko Takku}
\def\myfisubtitle{Stereo- ja segmentointikuvien yhdistäminen paremman syvyyskartan tuottamiseksi}
\def\myensubtitle{Using stereo depth and semantic segmentation dataset for generating a clean depthmap}
...
\input{tex/kirjallisuuskatsaus.tex}

\input{tex/teoria.tex}

\input{tex/aineisto.tex}
